...
defaults="--extraDelay 5 --stabilizeDelay 30 --channels 1,6,11"
...
info="firstLayer25"
demands=[1000, 10000, 24000, 54000]
            ...
            weigth_flowrates_def.each do |wf|
                demands.each do |demand|
                    (1..repetitions).each do |rep|
                        exp = { "protocol" => proto, "stack" => stack, "aggregation_enabled" => agg, "weigthFlowrates" => wf, "defaults" => defaults, "scriptFile" => "layer25/testLayer25.rb", "demands" => demand, "repetition" => rep, "info" => info, "topo" => topo }
                        $EXPS << exp
